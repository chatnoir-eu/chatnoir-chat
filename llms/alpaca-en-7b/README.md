...
```
docker run --rm -ti --entrypoint python3 registry.webis.de/code-lib/public-images/chatnoir-chat:0.0.1 run_inference.py --input_model /workspace/alpaca-7b
```

Run it locally (gpt2-base) via:

```
docker run --rm -ti --entrypoint python3 registry.webis.de/code-lib/public-images/chatnoir-chat-gpt2-base:0.0.1 run_inference.py --input_model /workspace/gpt2-base
```

Run it locally (gpt2-xl) via:

```
docker run --rm -ti --entrypoint python3 registry.webis.de/code-lib/public-images/chatnoir-chat-gpt2-xl:0.0.1 run_inference.py --input_model /workspace/gpt2-xl
```
...
**Please read README2.md for more details about the reproducing and inference**
